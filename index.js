...
console.log(color('> WA NUMBER: +919264142296 ','silver'))
...
dogexeon.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
   ...
   // owner
    ...
    const htod = "919264142296@s.whatsapp.net"
...
dogexeon.on('group-update', async (anu) => {
    ...
    dogexeon.on('chat-update', async (message) => {
        ...
        ownerNumber = ["919264142296@s.whatsapp.net","919264142296@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
        dtod = "919264142296@s.whatsapp.net"
